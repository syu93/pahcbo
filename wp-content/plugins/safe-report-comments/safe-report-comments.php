...
<?php
		...
		public function print_flagging_link( $comment_id='', $result_id='', $text='Signaler le commentaire' ) {
			echo $this->get_flagging_link( $comment_id='', $result_id='', $text='Signaler le commentaire' );
		}
		
		/* 
		 * Output Link to report a comment
		 */
		public function get_flagging_link( $comment_id='', $result_id='', $text='Signaler le commentaire' ) {
