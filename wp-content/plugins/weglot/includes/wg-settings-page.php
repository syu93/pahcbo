		...
		<table class="form-table">
			...
			<td>
				<select name="original_l" style="width :200px;">
					...
					<option <?php if(esc_attr( get_option('original_l') )=="zh") { echo "selected"; } ?> value="zh"><?php _e( 'Chinese', 'weglot' ); ?></option>
			...
			<td><input type="text" name="destination_l" value="<?php echo esc_attr( get_option('destination_l') ); ?>" placeholder="en,es" required /><?php if($this->userInfo['plan']<=0) { ?><p class="wg-fsubtext"><?php _e( 'On the free plan, you can only chose one language. If you want to use more than 1 language, please <a target="_blank" href="https://weglot.com/change-plan">upgrade your plan</a>.', 'weglot' ); ?></p><?php } ?></td>
			</tr>
		</table>	
...
color : blue!important;
		...
		<table class="form-table">
			<tr valign="top">
			<th scope="row"><?php _e( 'Exlude URL here', 'weglot' ); ?><p style="font-weight:normal;margin-top:2px;"><?php _e( 'You can write regex.', 'weglot' ); ?><p></th>
			<td><textarea type="text" rows = 3 cols = 30 name="exclude_url" placeholder=""><?php echo esc_attr( get_option('exclude_url') ); ?></textarea></td>
			</tr>
			<tr valign="top">
			<th scope="row"><?php _e( 'Exlude blocks', 'weglot' ); ?><p style="font-weight:normal;margin-top:2px;"><?php _e( 'Enter CSS selectors, separated by commas', 'weglot' ); ?><p></th>
